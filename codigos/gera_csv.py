...
#notas_dados = pd.read_csv("../dados/lop_exercicios_2022_07_05_t02.csv")
notas_dados = pd.read_csv("../dados/lop_exercicios_2022_07_25_t02.csv")
...
#notas_u2 = notas_dados.iloc[:,  [1, 10, 5, 2, 3, 6, 4]]
notas_u3 = notas_dados.iloc[:,  [1, 2, 3, 4]]
...
turma_sigaa = pd.read_csv("../dados/turma_02_2022_1_oriva.csv")
...
#padronizada_notas_u2.to_csv("../saida/notas_uniao_u2_completo.csv", index=False)
#padronizada_notas_u3.to_csv("../saida/notas_uniao_u3_completo.csv", index=False)
